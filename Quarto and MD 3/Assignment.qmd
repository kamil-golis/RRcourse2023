...
Below find description of this season - according to 1st episode of the season:

`r season_data$title[1]`

`r season_data$description[1]`
...
```{r}
above_avg <- season_data[season_data$viewers>mean(season_data$viewers),]
```
